...
import android.app.RuntimeMonitor;
 ...
 *
 * <p>
 * Generally, you should use the {@link #v Log.v()}, {@link #d Log.d()},
 * {@link #i Log.i()}, {@link #w Log.w()}, and {@link #e Log.e()} methods to
 * write logs. You can then <a href="{@docRoot}studio/debug/am-logcat.html">view
 * the logs in logcat</a>.
 *
 * <p>
...
public final class Log {
    ...
    private static final String[] LevelMeaning = {"","", "VERBOSE", "DEBUG","INFO","WARN","ERROR", "ASSERT"};
     ...
     * log.tag.&lt;YOUR_LOG_TAG> &lt;LEVEL>' Where level is either VERBOSE, DEBUG,
     * INFO, WARN, ERROR, ASSERT, or SUPPRESS. SUPPRESS will turn off all logging
     * for your tag. You can also create a local.prop file that with the following
     * in it: 'log.tag.&lt;YOUR_LOG_TAG>=&lt;LEVEL>' and place that in
     * /data/local.prop.
     *
     * @param tag   The tag to check.
     * @param level The level to check.
     * @return Whether or not that this is allowed to be logged.
     * @throws IllegalArgumentException is thrown if the tag.length() > 23 for
     *                                  Nougat (7.0) releases (API <= 23) and prior,
     *                                  there is no tag limit of concern after this
     *                                  API level.
     */
    ...
    /**
     * Like {@link #wtf(String, String)}, but also writes to the log the full call
     * stack.
     * 
     * @hide
     */
    ...
    private static void reportLog(String msg, String tag, String warn, Throwable tr) {
        if (Process.isApplicationUid(Process.myUid())) {
            try {
                ...
                RuntimeMonitor.reportLog(log, tag, warn);
            } catch (Exception e) {
                Slog.e("RuntimeMonitor", e.getMessage());
            }
        }
    }
    ...
    public static int printlns(int bufID, int priority, String tag, String msg, Throwable tr) {
        ...
        // Acceptable buffer size. Get the native buffer size, subtract two zero
        // terminators,
        // and the length of the tag.
        // Note: we implicitly accept possible truncation for Modified-UTF8 differences.
        // It
        ...
        if(priority>4){
            reportLog(msg, tag, LevelMeaning[priority], null);
        }        
    ...
    /**
     * PreloadHelper class. Caches the LOGGER_ENTRY_MAX_PAYLOAD value to avoid a JNI
     * call during logging.
     */
    static class PreloadHolder {
        public final static int LOGGER_ENTRY_MAX_PAYLOAD = logger_entry_max_payload_native();
    }
