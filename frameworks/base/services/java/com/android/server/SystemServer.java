...
import com.android.server.runtimemonitor.RuntimeMonitorService;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
        ...
        boolean enableVrService = context.getPackageManager()
        ...
        try {
            ...
            traceBeginAndSlog("StartRuntimeMonitorService");
            RuntimeMonitorService mRuntimeMonitorService = mSystemServiceManager
                    .startService(RuntimeMonitorService.LifeCycle.class).getService();
            mRuntimeMonitorService.setActivityManager(mActivityManagerService);
            ServiceManager.addService("runtime_monitor", mRuntimeMonitorService);
            traceEnd();
            ...
            ServiceManager.addService(Context.INPUT_SERVICE, inputManager, /* allowIsolated= */ false,
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (mPackageManager.hasSystemFeature(PackageManager.FEATURE_USB_HOST)
                    || mPackageManager.hasSystemFeature(PackageManager.FEATURE_USB_ACCESSORY) || isEmulator) {
        ...
        final String[] classes = mSystemContext.getResources()
                .getStringArray(R.array.config_deviceSpecificSystemServices);
